...
public class ConsejoModel_agua {
    ...
    public ConsejoModel_agua() {
    }

    public ConsejoModel_agua(long id, String consumo_alto_a, String consumo_regular_a, String consumo_bueno_a) {
        this.id = id;
